...
tk.Label(root, text="Tic Tac Toe", font=('Consolas', 25)).pack()
status_label = tk.Label(root, text="X's Turn", font=('Consolas', 15), bg='green', fg='snow')
...
play_again_button = tk.Button(root, text='Play Again', font=('Consolas', 12), command=play_again)
